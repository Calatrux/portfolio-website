...
import { Linkedin, Github, Mail } from 'lucide-react'; // Using lucide-react for icons
...
const socialLinks = [
  ...
  },
  {
    name: 'GitHub',
    icon: <Github size={32} />,
    url: 'https://github.com/Calatrux', // Replace with your GitHub URL
  },
  {
    name: 'Email',
    icon: <Mail size={32} />,
    url: 'mailto:shubm.prsd@gmail.com', // Replace with your email
  },
];
